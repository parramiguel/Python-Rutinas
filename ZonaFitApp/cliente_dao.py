...
class ClienteDAO:
    ...
    def seleccionar(cls):
        ...
        try:
            ...
            print(f'Ocurrio un error al selccionar clientes {e}')
        finally:
    ...
    def seleccionar_por_id(cls,id):
        ...
        try:
            ...
            print(f'Excepción al seleccionar cliente por id {e}')
        finally:
            if conexion is not None:
                cursor.close()
                Conexion.liberar_conexion(conexion)
...
if __name__ == '__main__':
    # Insertar cliente
    #cliente1 = Cliente(nombre='Angela', apellido='Galea', membresia=568)
